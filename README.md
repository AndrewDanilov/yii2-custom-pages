...
Pages grouped by categories. You can add anlimited count of categories with anlimited count pages inside each other. Each category can have own template for itself and separete template for pages stored in it.
